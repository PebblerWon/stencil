...
export function createNodeSys(c: { process?: any; logger?: Logger } = {}): CompilerSystem {
  ...
  sys.lazyRequire = new NodeLazyRequire(nodeResolve, {
    '@types/jest': { minVersion: '24.9.1', recommendedVersion: '30', maxVersion: '30.0.0' },
    jest: { minVersion: '24.9.0', recommendedVersion: '30', maxVersion: '30.0.0' },
    'jest-cli': { minVersion: '24.9.0', recommendedVersion: '30', maxVersion: '30.0.0' },
